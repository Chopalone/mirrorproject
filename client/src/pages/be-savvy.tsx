...
import { BookOpen, Calculator, TrendingUp, Shield, Users, Award, CheckCircle, DollarSign } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <h1 className="text-4xl lg:text-5xl font-bold leading-tight" style={{ color: '#3300FF' }}>
                Be Savvy
                <br />
                <span className="text-foreground">with Your Money</span>
                <br />
              ...
              <div className="space-y-3">
                <div className="flex items-center text-muted-foreground">
                  ...
                  <span>Expert financial education and resources</span>
                </div>
                <div className="flex items-center text-muted-foreground">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
                  <span>Interactive tools and calculators</span>
                </div>
                <div className="flex items-center text-muted-foreground">
                  <CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
                  <span>Build lasting wealth and financial freedom</span>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="rounded-2xl overflow-hidden shadow-xl">
                <img 
                  ...
                  alt="Financial education success"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style={{ backgroundColor: '#3300FF20' }}>
                <BookOpen className="w-8 h-8" style={{ color: '#3300FF' }} />
              </div>
              <h3 className="text-xl font-semibold text-foreground mb-2">Learn & grow</h3>
              <p className="text-muted-foreground">Access expert financial education and build your knowledge.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Calculator className="w-8 h-8 text-green-600" />
              </div>
              <h3 className="text-xl font-semibold text-foreground mb-2">Plan & calculate</h3>
              <p className="text-muted-foreground">Use interactive tools to plan your financial future.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <TrendingUp className="w-8 h-8 text-purple-600" />
              </div>
              <h3 className="text-xl font-semibold text-foreground mb-2">Build wealth</h3>
              <p className="text-muted-foreground">Create lasting financial freedom and security.</p>
            </div>
          </div>
          <div className="mt-12">
            <Button 
